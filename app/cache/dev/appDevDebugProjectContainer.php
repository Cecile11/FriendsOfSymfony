...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'zeta_user.profile.form.type' => 'getZetaUser_Profile_Form_TypeService',
            'zeta_user.registration.form.type' => 'getZetaUser_Registration_Form_TypeService',
        );
        $this->aliases = array(
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'friendstest', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Zeta\\UserBundle\\Resources\\config\\doctrine') => 'Zeta\\UserBundle\\Entity', ($this->targetDirs[3].'\\src\\Zeta\\TimelineBundle\\Resources\\config\\doctrine') => 'Zeta\\TimelineBundle\\Entity'));
        ...
        $c->addDriver($a, 'Zeta\\UserBundle\\Entity');
        $c->addDriver($a, 'Zeta\\TimelineBundle\\Entity');
        $c->addDriver($b, 'FOS\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('UserBundle' => 'Zeta\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'TimelineBundle' => 'Zeta\\TimelineBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7a9ead75efb9e7923fc357c5bb11b5ec1695b3de89cdd675a0bde63e5056ac8f');
    ...
    {
        return $this->services['fos_user.profile.form'] = $this->get('form.factory')->createNamed('fos_user_profile_form', 'zeta_user_profile', NULL, array('validation_groups' => array(0 => 'Profile', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Zeta\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'zeta_user_registration', NULL, array('validation_groups' => array(0 => 'Registration', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Zeta\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Zeta\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/timeline');
        ...
        $o->setOptions(array('login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/timeline', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('zetacseuom');
        $a->setPassword('zetacseuom2014');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Zeta\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Zeta\\TimelineBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Zeta\\UserBundle/Resources/views'), 'User');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Zeta\\TimelineBundle/Resources/views'), 'Timeline');
    ...
    /**
     * Gets the 'zeta_user.profile.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Zeta\UserBundle\Form\Type\ProfileFormType A Zeta\UserBundle\Form\Type\ProfileFormType instance.
     */
    protected function getZetaUser_Profile_Form_TypeService()
    {
        return $this->services['zeta_user.profile.form.type'] = new \Zeta\UserBundle\Form\Type\ProfileFormType('Zeta\\UserBundle\\Entity\\User');
    }

    /**
     * Gets the 'zeta_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Zeta\UserBundle\Form\Type\RegistrationFormType A Zeta\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getZetaUser_Registration_Form_TypeService()
    {
        return $this->services['zeta_user.registration.form.type'] = new \Zeta\UserBundle\Form\Type\RegistrationFormType('Zeta\\UserBundle\\Entity\\User');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UserBundle' => 'Zeta\\UserBundle\\UserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'TimelineBundle' => 'Zeta\\TimelineBundle\\TimelineBundle',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'zetacseuom',
            'swiftmailer.mailer.default.transport.smtp.password' => 'zetacseuom2014',
            ...
            'fos_user.model.user.class' => 'Zeta\\UserBundle\\Entity\\User',
            'fos_user.template.engine' => 'twig',
            'fos_user.profile.form.type' => 'zeta_user_profile',
            ...
            'fos_user.registration.form.type' => 'zeta_user_registration',
